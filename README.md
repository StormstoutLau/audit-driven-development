...
This skill provides adapter files for the following AI coding tools:
本 skill 为以下 AI coding 工具提供适配文件:
...
This skill supports multiple AI coding tools. Choose your tool below.
本 skill 支持多种 AI coding 工具，请根据你使用的工具选择对应安装方式。
...
Claude Code uses the same SKILL.md format as Trae (YAML frontmatter + markdown body).
Claude Code 使用与 Trae 相同的 SKILL.md 格式（YAML frontmatter + markdown body）。
